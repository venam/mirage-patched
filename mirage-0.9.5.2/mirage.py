...
class Base:
    ...
    def __init__(self):
        ...
        actions = (
            ...
            ('Space2', None, '', '<Shift>space', _('Previous Image'), self.goto_next_image),
        ...
        if event.type == gtk.gdk.SCROLL:
            ...
            if event.state & gtk.gdk.CONTROL_MASK:
                if event.direction == gtk.gdk.SCROLL_UP:
                    ...
                    self.zoom_out(None)
                return True
            # move horizontally on the selected image with mousewheel:
                ...
                if event.direction == gtk.gdk.SCROLL_UP:
                    ...
                    if newx >= xadjust.lower and newx <= xadjust.upper - xadjust.page_size:
                        ...
                        #self.goto_next_image(None)
                return True
            # move vertically on the selected image with mousewheel:
            else:
